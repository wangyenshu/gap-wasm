...
##  <Item>
##    If bound, the value must be a valid value of the <C>work.footer</C>
##    component of a browse table,
##    see <Ref Func="BrowseData.IsBrowseTable"/>;
##    for example, the value can be a list of strings.
##    If this component is not bound then the browse table has no footer.
##  </Item>
...
NCurses.BrowseDenseList:= function( list, arec )
      ...
      if IsBound( arec.footer ) then
        r.work.footer:= arec.footer;
      fi;
